from math import lcm as minimo_comun_multiplo
from math import gcd as maximo_comun_divisor
...
class Fraccion:
    ...
    def __add__(self, otro):
        ...
        mcm = minimo_comun_multiplo(self.denominador, otro.denominador)
        ...
        # multiplicamos la fraccion original por la fraccion 
        # unitaria(fraccion con valor 1)
        # al multiplicar por 1 el valor real de la fraccion no 
        # cambia pero logramos ponerlas con el mismo denominador. 
        # lo que nos facilita sumar solo los numeradores
        # para esto multiplicamos el numeradr y el denominador de cada 
        # fraccion por el valor que obtenemos en las variables 
        # fraccionUnitaria 1 y 2 segun corresponda
        nuevo_denominador = self.denominador * fraccion_unitaria1
        ...
        resultado = Fraccion(numerador_final, nuevo_denominador)
    ...
    def _simplificar_fraccion(self):
        ...
        divisor = maximo_comun_divisor(self.numerador,self.denominador)
